...
require('lazy').setup({
 ...
 -- restore cursor position in vim
    ...
    opts = {
      pickers = {
        find_files = {
          ...
          -- ripgrep to find hidden files and folders except .git/ 
          -- by default ripgrep takes everything from .gitignore into account
        },
        live_grep = {
  ...
  -- require 'custom.plugins.multiplecursors',
...
--vim.o.softtabstop = 4                 -- a combination of spaces and tabs are used to simulate tab stops at a width
